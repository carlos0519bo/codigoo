...
export const Select: React.FC<SelectProps> = ({
  ...
  const renderOptionLabel = getOptionLabel || defaultGetOptionLabel;
    ...
    <>
      <div className="relative h-10 w-full">
        ...
        >
          ...
          {options.map((option) => (
            <option key={option.value} value={optionValue ? option[optionValue as keyof SelectOption] : option.label}>
